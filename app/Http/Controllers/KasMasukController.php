...
class KasMasukController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $save_km->jmlkmd=$request->get('total'); 
        $save_km->save(); 
    ...
    public function show($id)
    {
        ...
        $detail = DB::select('SELECT akun.kdakun, 
        akun.nmakun,kas_masuk_det.nildb FROM kas_masuk_det, akun WHERE 
        akun.id=kas_masuk_det.idakun AND idkm = :id', ['id' => $km->id]);
